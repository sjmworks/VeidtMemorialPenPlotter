 ...
 *
 * 
 * MUNRO - I HAVE REWIRED ALL THE U PINS ONTO Y2. GOOD LUCK HAVE FUN
 */
...
#define Y2_DIAG_PIN                         PG14  // E2DET
#define V_DIAG_PIN                         PG15  // E3DET

//MUNRO: NEVER EVER EVER TRY AND DO SENSORLESSHOMING ON V IM USING THE PIN ON Y2

//
// Limit Switches
//

// Munro: i have changed a few of these to remap onto ymax/ymin, y2 etc. probaby wrong
#ifdef X_STALL_SENSITIVITY
  #define X_STOP_PIN                  X_DIAG_PIN
  #if X_HOME_TO_MIN
    #define X_MAX_PIN                J_DIAG_PIN  // E0DET
  #else
    #define X_MIN_PIN                J_DIAG_PIN  // E0DET
  #endif
#elif NEEDS_X_MINMAX
  #ifndef X_MIN_PIN
  ...
  #if Y_HOME_TO_MIN
    #define Y_MAX_PIN                K_DIAG_PIN  // E1DET
  #else
    #define Y_MIN_PIN                K_DIAG_PIN  // E1DET
  #endif
#elif NEEDS_Y_MINMAX
  #ifndef Y_MIN_PIN
  ...
  #ifndef I_MIN_PIN
    #define I_MIN_PIN                 Z_DIAG_PIN  // Z-STOP
  #endif
  #ifndef I_MAX_PIN
    #define I_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #endif
  ...
  #endif
#elif ENABLED(NEEDS_J_MINMAX)
  #ifndef J_MIN_PIN
    #define J_MIN_PIN                 Z_DIAG_PIN  // Z-STOP
  #endif
  #ifndef J_MAX_PIN
    #define J_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #endif
  ...
  #if K_HOME_TO_MIN
    #define K_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #else
    #define K_MIN_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#elif ENABLED(NEEDS_K_MINMAX)
  #ifndef K_MIN_PIN
    #define K_MIN_PIN                 Z_DIAG_PIN  // Z-STOP
  #endif
  #ifndef K_MAX_PIN
    #define K_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#else
  #define K_STOP_PIN                  K_DIAG_PIN  // Z-STOP
#endif

#ifdef Y2_STALL_SENSITIVITY
  #define Y2_STOP_PIN                  Y2_DIAG_PIN
  #if Y2_HOME_TO_MIN
    #define Y2_MAX_PIN                V_DIAG_PIN  // PWRDET
  #else
    #define Y2_MIN_PIN                V_DIAG_PIN  // PWRDET
  #endif
#elif ENABLED(NEEDS_Y2_MINMAX)
  #ifndef Y2_MIN_PIN
    #define Y2_MIN_PIN                 Y2_DIAG_PIN  // Z-STOP
  #endif
  #ifndef Y2_MAX_PIN
    #define Y2_MAX_PIN                V_DIAG_PIN  // PWRDET
  #endif
#else
  #define Y2_STOP_PIN                  Y2_DIAG_PIN  // Z-STOP
#endif

#ifdef V_STALL_SENSITIVITY
  #define V_STOP_PIN                  V_DIAG_PIN
  #if V_HOME_TO_MIN
    #define V_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #else
    #define V_MIN_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#elif ENABLED(NEEDS_V_MINMAX)
  #ifndef V_MIN_PIN
    #define V_MIN_PIN                 Z_DIAG_PIN  // Z-STOP
  #endif
  #ifndef V_MAX_PIN
    #define V_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#else
  #define V_STOP_PIN                  V_DIAG_PIN  // Z-STOP
#endif
...
#define Y2_STEP_PIN                         PE2   // MOTOR 6
#define Y2_DIR_PIN                          PE3
#define Y2_ENABLE_PIN                       PD4
#ifndef Y2_CS_PIN
  #define Y2_CS_PIN                         PE1
#endif
