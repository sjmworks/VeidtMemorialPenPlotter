...
#define HOMING_BUMP_DIVISOR { 5, 5, 1, 1, 1, 1 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 2, 2, 0, 0, 0, 0 }  // (linear=mm, rotational=°) Backoff from endstops after homing
#define XY_COUNTERPART_BACKOFF_MM 2        // (mm) Backoff X after homing Y, and vice-versa
