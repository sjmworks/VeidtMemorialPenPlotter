 ...
 */
  ...
  #define Y_DUAL_ENDSTOPS           // Y2 has its own endstop
    ...
    #define Y2_STOP_PIN PG14   // Y2 endstop pin override
...
#define HOMING_BUMP_MM      { 5, 5, 0, 0, 0, 0 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 1, 1, 1, 1 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1980        // (mA) RMS current. Multiply by 1.414 for peak current.
